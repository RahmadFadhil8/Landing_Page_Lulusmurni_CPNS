<template>
    <section>
        <div class="flex flex-col lg:flex-row justify-between items-center gap-6 lg:gap-12 sm:px-8 lg:px-24 xl:px-44 pt-28 lg:pt-24 min-h-screen bg-gradient-hero">
            ...
            <div class="w-full flex justify-center lg:justify-end">
                <img src="~/assets/images/ASNASN.png" alt="lulus murni ASN" class="w-96 h-auto">
            </div>
        </div>
    </section>
</template>