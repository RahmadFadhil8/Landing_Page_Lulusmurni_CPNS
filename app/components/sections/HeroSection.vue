<template>
    <section>
        <div class="flex flex-col lg:flex-row justify-between items-center gap-6 lg:gap-12 sm:px-8 lg:px-24 xl:px-44 pt-28 lg:pt-24 min-h-screen bg-[linear-gradient(to_top,#FFFFFF,#FFFFFF,#FFFFFF,#FFCFA2)]">
            <div class="flex flex-col items-center lg:flex lg:items-start p-8 w-full">
            ...
            <div class="w-full flex justify-center lg:justify-end">
                <img src="~/assets/images/ASNASN.png" alt="ASN" class="w-96 h-auto">
            </div>
        </div>
    </section>
</template>